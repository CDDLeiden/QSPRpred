"""Here extra model classes can be found.

At the moment this contains a class for py-boost models. To add more a model class
implementing the `QSPRModel` interface can be added, see tutorial adding_new_components.
"""
    ...
    def loadEstimatorFromFile(
        ...
        if os.path.isfile(path):
            ...
            if new_parameters is not None:
                return estimator(**new_parameters)
            else:
                return estimator
        elif fallback_load:
