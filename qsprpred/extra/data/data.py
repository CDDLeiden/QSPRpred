...
from ...data.utils.descriptorcalculator import (
    ...
    MoleculeDescriptorsCalculator, CustomDescriptorsCalculator,
)
...
class PCMDataSet(QSPRDataset):
    ...
    def addFeatures(
        ...
        for calc in feature_calculators:
            ...
            elif isinstance(calc, CustomDescriptorsCalculator):
                self.addCustomDescriptors(
                    calc,
                    recalculate=recalulate,
                    featurize=False
                )
