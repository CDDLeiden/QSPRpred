...
from qsprpred.data.data import QSPRDataset, TargetProperty, MoleculeTable
...
class PCMDataset(QSPRDataset):
    ...
    def addProteinDescriptors(self, calculator: ProteinDescriptorCalculator, recalculate=False, featurize=True):
        ...
        Args:
            ...
            featurize (bool): Whether to featurize the descriptors after adding them to the data frame.
        """
    ...
    def fromSDF(name, filename, smiles_prop, *args, **kwargs):
        raise NotImplementedError(
            f"SDF loading not implemented for {PCMDataset.__name__}, yet. You can convert from 'PCMTable' with 'fromMolTable'.")

    @staticmethod
    def fromMolTable(mol_table: MoleculeTable, proteincol, target_props: List[Union[TargetProperty, dict]],
            name=None, **kwargs):
        ...
        ds = PCMDataset(name, proteincol, target_props=target_props, df=mol_table.getDF(), **kwargs)
